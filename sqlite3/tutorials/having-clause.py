...
clause places condiitons on groups created by the GROUP BY clause.
"""
...
Following is the example, which would display record for which name count is less
than 2:
________________________________________________________________________________
...
Following is the example, which would display record for which name count is greater
than 2:
________________________________________________________________________________
sqlite> SELECT * FROM COMPANY GROUP BY name HAVING count(name) > 2;
________________________________________________________________________________
