...
#	2. If this 'else' should never run, beause it doesn't make sense,
#	then you must use a 'die' function in the 'else' that prints out an
#	error message and dies, just like we did in the last exercise. This
#	will find many errors.
#	3. Never nest 'if-statements' more than two deep and always try to
#	do them one deep.
...
# most programmers. Go back to the last exercise and see if I followed all
# of these rulse. If not, fix my mistakes.
...
#	on a sick person. You do not get any specific useful information,
#	and you find a whole lot of information that doesn't help and is
#	just confusing.
#	2. The best way to debug a program is to use 'print' to print out the
#	values of varibales at points in the program to see where they go wrong.
...
#	1. On a sheet of paper or an index card, write a list of tasks you
#	need to complete to finish the sofware. This is your to do list.
#	2. Pick the easiest thing you can do from your list.
#	3. Write out English comments in your source file as a guide for how
#	you would accmplish this task in your code.
#	4. Write some of the code under the English comments.
#	5. Quickly run your script to see if that code worked.
#	6. Keep working in a cycle of writing some code, running it to test it
#	and fixing it until it works.
#	7. Cross this task off your list, then pick your next easiest task
#	and repeat.