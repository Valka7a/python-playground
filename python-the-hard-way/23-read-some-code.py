...
#	3. Click on the 'Source' tab and browse through the list of
#	files and directorie until you find a .py file.
#	4. Start at the top and read through the code, taking notes
#	on what you think it does.
#	5. If any symbols or strange words seem to interest you,
#	write them down to research later.
